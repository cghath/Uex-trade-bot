...
83. **`/ship-parts-finder`'s comparison text was rebuilt from mockups, and making it
    readable exposed that most of what it listed was wrong for the slot.** (Numbered 83
    because PR #59's entry 82 was still open when this was written.) The owner's verdict on
    the old text was "looks terrible": each part was one line of raw wiki field names
